package CC;/*
אם הייתי בוחן את  HashMap
אז אחד המקרים שקשה לו להתמודד איתם זה מקרה שבו הפיזור של פונקציית ההאש
לא מיטבי - אז אפשר לראות מה עושים במקרה הזה.
תשתמשו ב-benchmarks (כמו שלמדנו, אפשר עם JMH)
בשביל למדוד בצורה איכותית את הביצועים שלו ולהשוות אל מול השינויים שתבצעו בו.
*/
